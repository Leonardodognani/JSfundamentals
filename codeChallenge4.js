...
TEST DATA: Test for bill values are 275, 40 and 430.
...
console.log(
  `The bill value was ${bill}, so, the tip is ${tip}, making a total of ${
    bill + tip
  }.`
);
...
console.log(
  `The bill value was ${bill}, so, the tip is ${
    bill >= 50 && bill <= 300 ? (tip = bill * 0.15) : (tip = bill * 0.2)
  }, making a total of ${bill + tip}.`
);
